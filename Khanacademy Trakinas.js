...
document.querySelector("link[rel~='icon']").href = 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/718smiley.png/640px-718smiley.png';
...
async function showSplashScreen() { 
    ...
    splashScreen.innerHTML = `
        <div>
            <span style="color:#FFFF33; text-shadow:0 0 5px #FFFF33,0 0 10px #FFFF33,0 0 15px #FFFF33; font-size:50px;">Trakinas</span><br>
            <span style="color:#FFFF33; text-shadow:0 0 5px #FFFF33,0 0 10px #FFFF33,0 0 15px #FFFF33; font-size:20px;">tava com saudades né?</span>
        </div>
    `;
...
async function hideSplashScreen() { 
    ...
    setTimeout(() => splashScreen.remove(), 1700); 
};
...
function setupMain(){
    ...
    (function () {
        const phrases = [
            "DZAAAAABERRRRDZOOOOO!!",
            "@takakokonish on Instagram",
            "adaiuduiu",
            "Trakinas say nigg nigg nigg",
            "Hello word",
        ];
...
.then(async () => {    
    ...
    await delay(1700);   // espera 1.7 segundos antes de esconder
    hideSplashScreen();
    setupMain();
